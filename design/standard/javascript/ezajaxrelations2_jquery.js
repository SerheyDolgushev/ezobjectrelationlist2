jQuery(function( $ )
{
            ...
            if ( data.content.SearchResultCount )
            {
                ...
                for ( var i = 0, l = arr.length; i < l; i++ )
                {
                    ...
                    aElem.bind( 'click', { boxID: boxID,
                        ...
                        ezajaxrelations2SearchAddObject( this, e.data.boxID, e.data.id, e.data.name, e.data.className, e.data.sectionName, e.data.publishedTxt );
                    } );
    ...
    function _addObject( link, boxID, id, name, className, sectionName, publishedTxt )
    {
        ...
        if ( listMode )
        {
            ...
            var priority = tr.find('td.priority input');
    ...
    window.ezajaxrelations2SearchAddObject = _addObject;
});
